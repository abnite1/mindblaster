...
-(IBAction) FireButton{
	...
	bullet0.center = CGPointMake(200,120);
	bullet0.hidden = NO;
}
...
-(void) onTimer {
	...
	for( i = 0; i <= 0; i++)
	{
		...
		for( i2 = 0; i2 <= 9; i2++)
		{
			...
			if(  ((tempBullet.center.x < tempAsteroid.center.x + 25) && (tempBullet.center.x > tempAsteroid.center.x - 25))
			     &&((tempBullet.center.y < tempAsteroid.center.y + 25) && (tempBullet.center.y > tempAsteroid.center.y - 25)) )
			{
